...
export const superAdminNav: SidebarNavItem[] = [
  ...
  { href: "/superadmin/courses", label: "Courses", icon: BookOpen },
  { href: "/superadmin/quizzes", label: "Quizzes", icon: Zap },
  { href: "/superadmin/exams/new", label: "Schedule Exam", icon: Clock },
  { href: "/superadmin/events", label: "Events", icon: Calendar },
  { href: "/superadmin/community", label: "Community", icon: MessageSquare },
  { href: "/superadmin/jobs", label: "Jobs", icon: Briefcase },
