    ...
    <header className="fixed top-4 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <Link href="/" className="flex items-center gap-2 shrink-0">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-r from-green-600 to-cyan-600">
        ...
        <div className="hidden md:block">
          <Link
            href="/get-started"
            className="rounded-xl bg-gradient-to-r from-green-600 to-cyan-600 px-5 lg:px-6 py-2.5 text-sm font-medium text-black transition hover:bg-gradient-to-r from-green-600 to-cyan-600"
          >
            Get Started
          </Link>
        </div>
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <Link
                href="/get-started"
                onClick={() => setMobileOpen(false)}
                className="mt-2 rounded-xl bg-gradient-to-r from-green-600 to-cyan-600 px-4 py-3 text-center text-sm font-medium text-black transition hover:bg-gradient-to-r from-green-600 to-cyan-800"
              >
                Get Started
              </Link>
            </div>
